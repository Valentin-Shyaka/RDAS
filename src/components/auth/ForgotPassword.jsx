...
const ForgotPassword = () => {
  return (
    <div className='text-center text-3xl justify-center p-4 flex items-center h-full w-screen gap-10'>
      <div className='bubble w-[200px] h-[200px] absolute left-[42%] top-[8%] sm:hidden lg:block'></div>
      <div className='bubble w-[150px] h-[150px] absolute left-[82%] top-[65%] sm:hidden lg:block'></div>
