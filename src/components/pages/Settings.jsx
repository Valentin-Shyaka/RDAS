...
const Settings = () => {
  ...
  return (
    <div className='p-8'>
        ...
        <div className='flex items-center w-full h-[80vh] gap-20 mt-8'>
            <Sidebar/>
            <div className='w-full'>
                ...
                <div className='w-[80%] border border-1 border-slate-400 rounded-3xl h-fit p-10 mt-6'>
                    ...
                    <hr className='mt-6 bg-slate-400 '/>
                    <div className='flex mt-4 justify-between  h-20 items-center'>
                        <div>
                            <h3 className='font-bold'>Your Profile</h3>
                            <p className='text-sm text-slate-400'>This will be displayed on your profile.</p>
                        </div>
                        <img src="./user_profile.png" alt="" srcset="" className='rounded-full w-20 h-20' />
