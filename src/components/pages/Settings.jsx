...
const Settings = () => {
  ...
  return (
    <div className='p-4 text-[0.8rem]'>
        ...
        <div className='flex items-center w-full h-[60%] gap-20 '>
            <Sidebar/>
            <div className='w-full'>
                ...
                <div className='w-[80%] border border-1 border-slate-400 rounded-3xl h-fit p-4 mt-4'>
                    ...
                    <p className='text-sm text-slate-400 mt-2 md:hidden lg:block'>Update your photo and personnal details here</p>
                    ...
                    <div className='flex mt-2 justify-between  h-16 items-center'>
                        <div>
                            ...
                            <p className='text-sm text-slate-400 md:hidden lg:block'>This will be displayed on your profile.</p>
                        </div>
