...
const MusicPlayer = () => {
  return (
    <div className='mt-6 bg-[#1E1E1E] w-full h-28 rounded-xl flex p-4 gap-4 text-center relative'>
      ...
      <div className='h-full items-center w-full p-4'>
        ...
        <div className='h-1 w-full bg-[#87888C] rounded-lg mt-2'>
