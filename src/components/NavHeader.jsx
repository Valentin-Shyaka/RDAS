...
const NavHeader = ({title}) => {
  return (
    <div className='flex w-full h-fit items-center gap-16 mb-2'>
        ...
        <h3 className='text-3xl font-bold ml-10'>{title}</h3>
        ...
        <div className='flex float-right ml-[10vw] gap-6 items-center'>
